...
import 'package:test_bugbaboo/features/screen/action_section/data/action_data.dart';
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: mockActionData.length,
              itemBuilder: (context, index) {
                final item = mockActionData[index];
                return MovieList(
                  rank: item.id,
                  title: item.title,
                  count: item.views,
