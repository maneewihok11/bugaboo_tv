...
import 'package:test_bugbaboo/features/screen/drama_section/data/drama_data.dart';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              AppText('ดรามาน้ำตาคอล', fontSize: 24),
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: mockDramaData.length,
              itemBuilder: (context, index) {
                final item = mockDramaData[index];
                return MovieList(
                  rank: item.id,
                  title: item.title,
                  count: item.views,
